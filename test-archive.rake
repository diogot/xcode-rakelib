...
def default_artifacts_path
  artifacts_path = ENV['ARTIFACTS_PATH'] || Path.of(test_archive_config['build_path'], fail_when_missing: false)
...
def default_reports_path
  reports_path = ENV['TEST_REPORTS_PATH'] || Path.of(test_archive_config['reports_path'], fail_when_missing: false)
